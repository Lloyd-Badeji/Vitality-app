      ...
      <div className="lg:hidden block absolute top-28 w-full left-0 right-0 bg-black transition">
        <ul className="text-center text-2xl p-20">
          ...
          <Link spy={true} smooth={true} to="About">
            <li className="my-4 py-4 border-b border-slate-800 hover:bg-button hover:text-black hover:rounded">Features</li>
          </Link>

          <Link spy={true} smooth={true} to="Skills">
            <li className="my-4 py-4 border-b border-slate-800 hover:bg-button hover:text-black hover:rounded">Classes</li>
          </Link>
          ...
          <Link spy={true} smooth={true} to="Contact">
            <li className="my-4 py-4 border-b border-slate-800 hover:bg-button hover:text-black hover:rounded">Contact</li>
          </Link>
        </ul>
      </div>
    </>
        ...
        <div className="text-text-color lg:flex md:flex flex-1  justify-end  hidden">
          ...
          <div> 
            <ul className="flex gap-8 mr-16">
              ...
              <Link spy={true} smooth={true} to="About">
                <li className="hover:text-white transition border-b-2 border-bg-color hover:border-button cursor-pointer">Features</li>
              </Link>

              <Link spy={true} smooth={true} to="Skills">
                <li className="hover:text-white transition border-b-2 border-bg-color hover:border-button cursor-pointer">Classes</li>
              </Link>
              ...
              <Link spy={true} smooth={true} to="Contact">
                <li className="hover:text-white transition border-b-2 border-bg-color hover:border-button cursor-pointer">Contact</li>
              </Link>
            </ul>
          </div>
        </div>
